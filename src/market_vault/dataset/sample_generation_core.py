...
# ---------------------------------------------------------------------------
# Strict split-spec JSON loading (single shared authority).
# ---------------------------------------------------------------------------
#
# Split-spec JSON documents are read by the shared
# :func:`load_sample_generation_split_spec` authority
# (:mod:`market_vault.dataset.sample_generation_split`), extracted verbatim
# from this core in PR-4. Both the generator core and the Sample Generation
# CLI build-plan writer consume exactly that loader: strict UTF-8 without
# BOM, any-depth duplicate-key rejection, the exact field set, strict
...
# second split identity is introduced.
